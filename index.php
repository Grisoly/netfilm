<?php
    ...
    //recuperer les donnees depuis la bdd avec un requete sql

    $requete = $bdd->prepare('SELECT * FROM films');
    // var_dump($requete);
    $requete->execute();
    // var_dump($requete);
...
<body>
    ...
    include 'header.php';
?>
    <div div class="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-24 lg:py-36">
            <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                <button
                    class="ouvrir-modale relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-red-900/40 hover:ring-gray-900/20">
                    #Hashtag
                </button>
            </div>
            <div class="text-center">
                <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Films et séries en illimité, et
                    bien plus</h1>
                <p class="mt-6 text-lg leading-8 text-gray-600">Prêt à regarder NetFilms ? Saisissez votre adresse
                    e-mail pour vous abonner ou réactiver votre abonnement.</p>
                <div class="mt-10 flex items-center justify-center gap-x-6">
                    <a href="/netfilm/form_ajout.php"
                        class="flex items-center gap-2 rounded-md bg-red-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600  hover:scale-110 transition-all"><svg
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-6 h-6 pt-1"
                            fill="currentColor">
                            <path
